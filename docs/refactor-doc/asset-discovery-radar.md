...
| `discoveryEvidenceBuilder` | 把新闻、行情、宏观、已有投资判断转成可审计证据 |
...
| 主题相关 | 与 topic query、seed symbols、已有投资判断的语义相关性 |
