...
const ASSISTANT_TOOL_CATALOG: DaaAgentToolMeta[] = [
  ...
  { intent: "brain_status", name: "get_brain_status", description: "返回当前投资助理可见能力、模型路由、复核链路与动作边界。" },
  { intent: "brain_set_mode", name: "set_brain_mode", description: "切换当前投资助理授权等级到仅建议、手动复核或自动复核。" },
  ...
  { intent: "agent_run", name: "run_cognitive_cycle", description: "手动触发一轮投资助理复核。" },
  { intent: "agent_bootstrap", name: "bootstrap_theses", description: "基于当前持仓建立初始投资判断。" },
  ...
  { intent: "thesis_status", name: "get_thesis_status", description: "查询投资助理的活跃投资判断状态。" },
  { intent: "agent_briefing", name: "get_agent_briefing", description: "查询最新复核简报（需要复核的变化、投资判断复核、改变判断的条件）。" },
  { intent: "llm_answer", name: "answer_with_llm", description: "用上下文、会话摘要和学习摘要生成自由问答回复。" },
