...
describe('feature-auto-wqat-precheck-simulator-f0093-v0', () => {
  it('adds review-priority telemetry to W_qat precheck verdict', () => {
    const file = resolve(process.cwd(), 'app/daa/market/funds/_components/DaaRebalancePanelDecisionCardsV0.tsx');
    const source = readFileSync(file, 'utf8');

    expect(source).toContain("const wQatPrecheckReviewPriority = wQatPrecheckPressureMode === 'critical-pressure'");
