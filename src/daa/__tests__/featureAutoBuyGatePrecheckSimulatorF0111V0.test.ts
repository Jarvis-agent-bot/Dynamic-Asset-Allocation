...
describe('feature-auto-buy-gate-precheck-simulator-f0111-v0', () => {
  it('adds SLA-lane telemetry to auto-buy precheck simulator verdict', () => {
    const file = resolve(process.cwd(), 'app/daa/market/funds/_components/DaaRebalancePanelDecisionCardsV0.tsx');
    const source = readFileSync(file, 'utf8');

    expect(source).toContain("const buyGatePrecheckSlaLane = buyGatePrecheckReviewPriority === 'p1'");
