...
describe("getDaaLoginAuthedRedirect", () => {
  ...
  it("redirects /daa/login to dashboard console when session exists", () => {
  ...
  it("maps returnTo deep-links into canonical /daa/dashboard", () => {
    ...
    expect(u3).toBe("/daa/dashboard?section=security#x");
  });
