...
describe('feature-auto-guardrail-timeline-audit-f0087-v0', () => {
  it('adds review-priority telemetry to guardrail timeline verdict', () => {
    const file = resolve(process.cwd(), 'app/daa/market/funds/_components/DaaRebalancePanelDecisionCardsV0.tsx');
    const source = readFileSync(file, 'utf8');

    expect(source).toContain("const guardrailTimelineReviewPriority = guardrailTimelinePressureMode === 'critical-pressure'");
