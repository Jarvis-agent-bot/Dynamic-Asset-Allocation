...
describe('feature-auto-guardrail-precheck-simulator-f0112-v0', () => {
  it('adds SLA-lane telemetry to guardrail precheck simulator verdict', () => {
    const file = resolve(process.cwd(), 'app/daa/market/funds/_components/DaaRebalancePanelDecisionCardsV0.tsx');
    const source = readFileSync(file, 'utf8');

    expect(source).toContain("const guardrailPrecheckSlaLane = guardrailPrecheckReviewPriority === 'p1'");
