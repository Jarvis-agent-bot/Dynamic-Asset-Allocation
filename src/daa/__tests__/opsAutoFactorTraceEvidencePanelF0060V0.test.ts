...
describe('ops-auto-factor-trace-evidence-panel-f0060-v0', () => {
  it('adds pressure-mode telemetry to factor-trace evidence verdict', () => {
    const file = resolve(process.cwd(), 'app/daa/market/funds/_components/DaaRebalancePanelDecisionCardsV0.tsx');
    const source = readFileSync(file, 'utf8');

    expect(source).toContain("const factorTraceEvidencePressureMode = factorTraceEvidenceBlockedCount === 0");
