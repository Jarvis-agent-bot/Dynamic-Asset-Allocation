...
import { patchDaaAssetUniverseRowV1, upsertDaaAssetUniverseRowV1 } from "@/src/daa/store/daaStorePgV1";
...
const MOCK_ASSET_ROW = {
  ...
  yfinanceSymbol: "AAPL",
  priceStatus: "fresh",
  priceAsOf: "2026-03-01T00:00:00.000Z",
  ...
  beforeEach(() => {
    ...
    vi.mocked(buildOpportunityPanelV1).mockResolvedValue({
      ...
      opportunities: [{
        ...
        riskScorePct: 78,
        action: "watch",
        scores: { human: 66, news: 64, technical: 68, penalty: 0 },
