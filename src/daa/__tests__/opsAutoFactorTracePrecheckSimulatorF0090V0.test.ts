...
describe('ops-auto-factor-trace-precheck-simulator-f0090-v0', () => {
  it('adds review-priority telemetry to factor-trace precheck verdict', () => {
    const file = resolve(process.cwd(), 'app/daa/market/funds/_components/DaaRebalancePanelDecisionCardsV0.tsx');
    const source = readFileSync(file, 'utf8');

    expect(source).toContain("const factorPrecheckReviewPriority = factorPrecheckPressureMode === 'critical-pressure'");
