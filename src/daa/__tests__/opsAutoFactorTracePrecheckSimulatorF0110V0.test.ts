...
describe('ops-auto-factor-trace-precheck-simulator-f0110-v0', () => {
  it('adds SLA-lane telemetry to factor-trace precheck verdict', () => {
    const file = resolve(process.cwd(), 'app/daa/market/funds/_components/DaaRebalancePanelDecisionCardsV0.tsx');
    const source = readFileSync(file, 'utf8');

    expect(source).toContain("const factorPrecheckSlaLane = factorPrecheckReviewPriority === 'p1'");
