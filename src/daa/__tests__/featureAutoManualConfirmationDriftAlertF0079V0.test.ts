...
describe('feature-auto-manual-confirmation-drift-alert-f0079-v0', () => {
  it('adds review-priority telemetry to manual confirmation drift alert verdict', () => {
    const file = resolve(process.cwd(), 'app/daa/market/funds/_components/DaaRebalancePanelDecisionCardsV0.tsx');
    const source = readFileSync(file, 'utf8');

    expect(source).toContain("const manualConfirmationDriftReviewPriority = manualConfirmationDriftPressureMode === 'critical-pressure'");
