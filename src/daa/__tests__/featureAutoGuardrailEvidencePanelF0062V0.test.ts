...
describe('feature-auto-guardrail-evidence-panel-f0062-v0', () => {
  it('adds pressure-mode telemetry to guardrail evidence verdict', () => {
    const file = resolve(process.cwd(), 'app/daa/market/funds/_components/DaaRebalancePanelDecisionCardsV0.tsx');
    const source = readFileSync(file, 'utf8');

    expect(source).toContain("const guardrailEvidencePressureMode = guardrailEvidenceReviewCount === 0");
