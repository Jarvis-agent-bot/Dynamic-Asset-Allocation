...
export function buildAssetUniverseViewRows(input: {
  ...
  return rows.map((row, index) => {
    ...
    return {
      ...
      autoEntryEnabled: row.autoEntryEnabled,
      entryTargetWeightPct: row.entryTargetWeightPct,
      entryCooldownDays: row.entryCooldownDays,
      lastEntryTriggeredAt: row.lastEntryTriggeredAt,
