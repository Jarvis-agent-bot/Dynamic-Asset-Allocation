...
export type CashClassificationV2 = {
  // ── Tier 1 ──────────────────────────────────────────────────────
  /** 运营储备金额（基准货币）*/
...
export type CashClassificationConfigV2 = {
  /**
...
export type CashClassificationInputV2 = {
  /** 账户总现金余额（基准货币）*/
  totalCash: number;
  /** 冻结现金（挂单中等）*/
  frozenCash: number;
  ...
  /** 配置参数 */
  config: CashClassificationConfigV2;
  /**
 ...
 */
export function classifyCashV2(input: CashClassificationInputV2): CashClassificationV2 {
  ...
  // ── 建议 ─────────────────────────────────────────────────────────
  let cashDeployAdvice: CashClassificationV2["cashDeployAdvice"];
