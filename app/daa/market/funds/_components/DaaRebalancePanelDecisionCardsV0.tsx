...
} from '@/src/daa/scenarioRoutingV0';
      ...
      {(() => {
        ...
        return (
          <div style={{ marginTop: 8, padding: '10px 12px', border: `1px solid ${routing.scenario === 'A' ? 'rgba(34,197,94,0.45)' : 'rgba(239,68,68,0.45)'}`, borderRadius: 12, background: routing.scenario === 'A' ? 'rgba(22,163,74,0.08)' : 'rgba(220,38,38,0.08)' }}>
            ...
            <div className="muted" style={{ marginTop: 4, fontSize: 11 }}>
              explicit rule: scenario B when stress score ≥ {SCENARIO_ROUTING_STRESS_SCORE_THRESHOLD_V0} or deep negatives ≥ {SCENARIO_ROUTING_DEEP_NEGATIVE_THRESHOLD_V0}; otherwise scenario A.
            </div>
