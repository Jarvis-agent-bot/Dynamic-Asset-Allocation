          ...
          <div style={{ marginTop: 8, padding: '10px 12px', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 12, background: 'rgba(0,0,0,0.1)' }}>
            ...
            <div style={{ marginTop: 6, padding: '8px 10px', border: '1px dashed rgba(56,189,248,0.35)', borderRadius: 10, background: 'rgba(56,189,248,0.06)', fontSize: 11 }}>
              ...
              <div className="muted" style={{ marginTop: 4, display: 'grid', gap: 2, fontSize: 11 }}>
                ...
                <div>T5 timeline telemetry: readiness=<b>{wQatPrecheckReadinessPct}%</b> · route=<b>{wQatPrecheckRouteMode}</b> · critical gates=<b>{wQatTimelineCriticalCount}</b> · escalation lane=<b>{wQatTimelineEscalationLane}</b> · pressure mode=<b>{wQatTimelinePressureMode}</b> · review priority=<b>{wQatTimelineReviewPriority}</b></div>
            ...
            <div style={{ marginTop: 6, padding: '8px 10px', border: `1px dashed ${wQatFormulaDriftAlertCount > 0 ? 'rgba(245,158,11,0.55)' : 'rgba(34,197,94,0.55)'}`, borderRadius: 10, background: 'rgba(255,255,255,0.01)', fontSize: 11 }}>
              ...
              <div className="muted" style={{ marginTop: 4, display: 'grid', gap: 2, fontSize: 11 }}>
                ...
                <div>drift alert verdict: alerts=<b>{wQatFormulaDriftAlertCount}/{wQatFormulaDriftAlertRows.length}</b> · mode=<b>{wQatFormulaDriftAlertCount > 0 ? 'formula-drift-review-required' : 'formula-drift-stable'}</b> · readiness=<b>{wQatFormulaDriftReadinessPct}%</b> · route=<b>{wQatFormulaDriftRouteMode}</b> · critical alerts=<b>{wQatFormulaCriticalDriftCount}</b> · escalation lane=<b>{wQatFormulaDriftEscalationLane}</b> · pressure mode=<b>{wQatFormulaDriftPressureMode}</b> · review priority=<b>{wQatFormulaDriftReviewPriority}</b> · sla lane=<b>{wQatFormulaDriftSlaLane}</b></div>
              ...
              return (
                <>
                  ...
                  <div style={{ marginTop: 6, padding: '8px 10px', border: '1px dashed rgba(255,255,255,0.2)', borderRadius: 10, background: 'rgba(255,255,255,0.01)', fontSize: 11 }}>
                    ...
                    <div className="muted" style={{ marginTop: 4, fontSize: 11 }}>
                      Auto-buy precheck simulator: ready rows=<b>{readyRows}/{precheckRows.length}</b> · route mode=<b>{routeMode}</b> · readiness=<b>{buyGatePrecheckReadinessPct}%</b> · handoff=<b>{buyGatePrecheckHandoffMode}</b> · critical rows=<b>{buyGatePrecheckCriticalCount}</b> · escalation lane=<b>{buyGatePrecheckEscalationLane}</b> · pressure mode=<b>{buyGatePrecheckPressureMode}</b> · review priority=<b>{buyGatePrecheckReviewPriority}</b>
          ...
          <div style={{ marginTop: 8, padding: '10px 12px', border: `1px solid ${gate === 'pass' ? 'rgba(34,197,94,0.45)' : 'rgba(239,68,68,0.45)'}`, borderRadius: 12, background: gate === 'pass' ? 'rgba(22,163,74,0.08)' : 'rgba(220,38,38,0.08)' }}>
            ...
            <div style={{ marginTop: 6, padding: '8px 10px', border: `1px dashed ${manualCheckpointConfirmed ? 'rgba(34,197,94,0.55)' : 'rgba(245,158,11,0.55)'}`, borderRadius: 10, background: manualCheckpointConfirmed ? 'rgba(22,163,74,0.08)' : 'rgba(245,158,11,0.08)', fontSize: 11 }}>
              ...
              <div className="muted" style={{ marginTop: 4, display: 'grid', gap: 2, fontSize: 11 }}>
                ...
                <div>T5 timeline telemetry: readiness=<b>{manualPrecheckReadinessPct}%</b> · route=<b>{manualPrecheckRouteMode}</b> · critical gates=<b>{manualTimelineCriticalCount}</b> · escalation lane=<b>{manualTimelineEscalationLane}</b> · pressure mode=<b>{manualTimelinePressureMode}</b> · review priority=<b>{manualTimelineReviewPriority}</b></div>
