...
function useLocalStorageStringV0(key: string, fallback = '') {
...
function useLocalStorageOptionalNumberV0(key: string) {
...
function useLocalStorageFiniteNumberV0(key: string, fallback = 0) {
