...
import { useWorkbenchAssetActionsV1 } from "@/app/daa/dashboard/_hooks/workbench/useWorkbenchAssetActionsV1";
import { useWorkbenchExecutionFlowV1 } from "@/app/daa/dashboard/_hooks/workbench/useWorkbenchExecutionFlowV1";
import { useWorkbenchRebalanceFlowV1 } from "@/app/daa/dashboard/_hooks/workbench/useWorkbenchRebalanceFlowV1";
import { useWorkbenchModelV1 } from "@/app/daa/dashboard/_hooks/useWorkbenchModelV1";
import type { ExecutionReceiptV1 } from "@/app/daa/dashboard/_hooks/workbench/workbenchPageTypesV1";
import type { RebalanceCycleV1 } from "@/src/daa/modules/workbench/workbenchTypesV1";

export type { ExecutionReceiptV1 } from "@/app/daa/dashboard/_hooks/workbench/workbenchPageTypesV1";

export function useWorkbenchPageModelV1(input: {
  initialTab?: string;
  syncPrices?: boolean;
  ...
  const rebalanceFlow = useWorkbenchRebalanceFlowV1({
    bootstrap,
    assetRows,
    cycles,
    currentCycle,
  ...
  const executionFlow = useWorkbenchExecutionFlowV1({
    currentCycle,
  ...
  return {
    ...
    holdingsValue,
    cashValue,
    executionReceipt: executionFlow.executionReceipt as ExecutionReceiptV1 | null,
...
export type WorkbenchPageModelV1 = ReturnType<typeof useWorkbenchPageModelV1>;
