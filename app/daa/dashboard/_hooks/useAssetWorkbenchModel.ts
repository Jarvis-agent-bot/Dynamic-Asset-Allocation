...
import { useAssetActions } from "@/app/daa/dashboard/_hooks/asset-workbench/useAssetActions";
import { useExecutionFlow } from "@/app/daa/dashboard/_hooks/asset-workbench/useExecutionFlow";
...
export type { ExecutionReceipt } from "@/app/daa/dashboard/_hooks/asset-workbench/assetWorkbenchTypes";

export function useAssetWorkbenchModel(input: {
  initialTab?: string;
  syncPrices?: boolean;
...
export type AssetWorkbenchModel = ReturnType<typeof useAssetWorkbenchModel>;
