  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ ...settingsGridCols2StyleV1, marginTop: 16 }}>
          <div>
            <FieldLabelV1>刷新间隔（分钟）</FieldLabelV1>
            <NumberInputV1
        ...
        <div style={{ marginTop: 16 }}>
          <FieldLabelV1>指标开关与权重</FieldLabelV1>
          <div style={{ display: "grid", gap: 12, gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))" }}>
            {MARKET_INDICATOR_ITEMS_V1.map((item) => (
              <div
                key={item.key}
                style={{
                  borderRadius: 10,
        ...
        <div style={{ marginTop: 16 }}>
          ...
          <div style={settingsGridCols3StyleV1}>
            ...
            <div>
              <FieldLabelV1>偏防守环境买入执行系数</FieldLabelV1>
              <NumberInputV1
            ...
            <div>
              <FieldLabelV1>高波动资产买入执行系数</FieldLabelV1>
              <NumberInputV1
