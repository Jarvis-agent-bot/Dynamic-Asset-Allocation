...
export function SettingsStrategySectionV1(props: {
  ...
  return (
    <section id="settings-strategy" className="scroll-mt-28">
      <SectionCardV1 title="再平衡策略" description="支持定期触发和偏移触发，两者可并行启用。">
        <div style={settingsGridCols2StyleV1}>
          ...
          <div>
            <FieldLabelV1>定期频率</FieldLabelV1>
            <FormSelectV1
          ...
          <div>
            <FieldLabelV1>执行日（1-28）</FieldLabelV1>
            <NumberInputV1
          ...
          <div>
            <FieldLabelV1>偏移阈值 (%)</FieldLabelV1>
            <NumberInputV1
          ...
          <div>
            <FieldLabelV1>检查频率</FieldLabelV1>
            <FormSelectV1
          ...
          <div>
            <FieldLabelV1>冷静期（小时）</FieldLabelV1>
            <NumberInputV1
          ...
          <div>
            <FieldLabelV1>自动分析时间（UTC）</FieldLabelV1>
            <FormInputV1
          ...
          <div>
            <FieldLabelV1>通知邮箱</FieldLabelV1>
            <FormInputV1
          ...
          <div style={{ gridColumn: "1 / -1" }}>
            <FieldLabelV1>AI 关注重点</FieldLabelV1>
            <FormInputV1
