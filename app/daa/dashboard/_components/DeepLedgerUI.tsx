...
const ACCENT_CLASS: Record<DeepLedgerTone, string> = {
  cyan: "var(--primary)",
  amber: "var(--amber)",
  green: "var(--success)",
  red: "var(--danger)",
...
const TONE_STYLE: Record<DeepLedgerTone, { border: string; bg: string; text: string }> = {
  cyan: {
...
export type DeepLedgerTone = "cyan" | "amber" | "green" | "red" | "indigo" | "slate";

export const deepLedgerFieldClassName =
...
export const deepLedgerDenseFieldClassName =
...
export const deepLedgerTableShellClassName =
...
export const deepLedgerTableHeadClassName =
...
export const deepLedgerTableCellClassName =
  "border-b border-[var(--border)]/70 px-4 py-3 align-top text-sm";

export const deepLedgerDialogContentClassName =
...
export function toneColor(tone: DeepLedgerTone = "cyan") {
  return ACCENT_CLASS[tone];
}

export function DeepLedgerPageHeader({
  eyebrow,
  title,
  description,
  actions,
...
export function DeepLedgerMetricCard({
  label,
  value,
  subLabel,
  accent = "cyan",
...
export function DeepLedgerPanel({
  title,
  subtitle,
  accent = "cyan",
  action,
...
export function DeepLedgerMiniStat({
  label,
  value,
  hint,
  tone = "slate",
...
export function DeepLedgerFilterChip({
  active,
  children,
  className,
  ...props
...
export function DeepLedgerStatusPill({
  tone = "slate",
  children,
  className,
}: {
...
export function DeepLedgerNoticeBox({
  tone = "slate",
  title,
  description,
  icon,
...
export function DeepLedgerEmptyState({
  title,
  description,
  action,
  className,
...
export const DeepLedgerActionButton = forwardRef<HTMLButtonElement, ButtonHTMLAttributes<HTMLButtonElement> & {
  tone?: "primary" | "slate" | "success" | "warning" | "danger";
  children: ReactNode;
}>(function DeepLedgerActionButton({
  children,
  tone = "slate",
  className,
  ...props
...
export function DeepLedgerDialogShell({
  accent = "cyan",
  title,
  description,
  badges,
  ...
  return (
    <DialogContent
      {...props}
      className={cn(deepLedgerDialogContentClassName, className)}
    >
...
export function DeepLedgerSectionAnchor({
  label,
  active,
  href,
  onClick,
